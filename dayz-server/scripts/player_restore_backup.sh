...
sqlite3 "$DayzServerFolder/$DayzPlayerDbFile" "UPDATE Players SET Alive = 1 WHERE PlayerId = '$PlayerId';"
sqlite3 "$DayzServerFolder/$DayzPlayerDbFile" "UPDATE Players SET Data = X'$Backup' WHERE PlayerId = '$PlayerId';"