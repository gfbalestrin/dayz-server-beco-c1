...
def criar_tabelas():
    ...
    CREATE TABLE IF NOT EXISTS player_loadouts_weapons (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        player_loadout_id INTEGER NOT NULL,
        ...
        FOREIGN KEY (player_loadout_id) REFERENCES player_loadouts(id) ON DELETE CASCADE,
    ...
    CREATE TABLE IF NOT EXISTS player_loadouts_items (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        player_loadout_id INTEGER NOT NULL,
        ...
        UNIQUE (player_loadout_id, item_id)
    );
    ...
    CREATE TABLE IF NOT EXISTS player_loadouts (
        ...
        name TEXT NOT NULL, -- Ex: "Loadout Stealth", "Explosivo"
        created_at TEXT DEFAULT CURRENT_TIMESTAMP,
        is_active INTEGER DEFAULT 0,
        FOREIGN KEY (player_id) REFERENCES player_logins(player_id),
        UNIQUE(player_id, name) -- Um jogador não pode ter dois loadouts com o mesmo nome
    );
